                ...
                <div class="col-4">
                    ...
                    <div class="card card-success card-outline" id="TambahDataPendaftaranRawatInap">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col"><a class="btn btn-block btn-outline-success"
                                        href="{{url('/Data_Pendaftaran_Rawat_Inap/tambah/#TambahPendaftaranRawatJalan')}}"><i
                                            class="fa fa-plus-circle"></i> DAFTAR</a></div>
                                <div class="col"><button type="button" class="btn btn-block btn-outline-success "><i
                                            class="fa fa-plus-circle"></i> PERAWATAN</button></div>
                            </div>
                            <div class="row">
                                <div class="col"><a href="" id="" class="btn btn-block btn-outline-primary btn-sm"><i
                                            class=""></i> Cari Pasien RI</a></div>
                                <div class="col"><a href="javascript:alert('Pilih baris data yang akan diubah!');"
                                        id="tombolubah" class="btn btn-block btn-outline-primary btn-sm"><i
                                            class="fa fa-print"></i> Ubah</a></div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col"><button type="button"
                                        class="btn btn-block btn-outline-danger btn-sm"><i
                                            class="fa fa-minus-circle"></i> Batalkan</button></div>
                            </div>
                            <div class="row">
                                <div class="col"><a href="javascript:alert('Pilih baris data yang akan diubah!');"
                                        id="tombolubahkamar" class="btn btn-block btn-outline-info btn-sm"><i
                                            class="fas fa-clipboard-list"></i> Ubah Kamar</a></div>
                                <div class="col"><button type="button" class="btn btn-block btn-outline-info btn-sm"><i
                                            class="fas fa-clipboard-list"></i> Pindah Kamar</button></div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col"><a href="javascript:alert('Pilih baris data yang akan diubah!');"
                                        id="tomboldetaildiagnosa" class="btn btn-block btn-outline-secondary btn-sm"><i
                                            class="fa fa-print"></i> Detail Diagnosa</a></div>
                            </div>
                            <div class="row">
                                <div class="col"><button type="button" class="btn btn-block btn-outline-info btn-sm"><i
                                            class="fas fa-clipboard-list"></i> Riwayat Resume Medis Pasien RJ</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col"><button type="button"
                                        class="btn btn-block btn-outline-success btn-sm"><i
                                            class="fa fa-plus-circle"></i> Asesmen Pasien Rawat Inap</button></div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col"><a href="javascript:alert('Pilih baris data yang akan diubah!');"
                                        id="tomboldetailpendaftaran"
                                        class="btn btn-block btn-outline-secondary btn-sm"><i class="fa fa-print"></i>
                                        Detail Pendaftaran</a></div>
                                <div class="col"><button type="button" class="btn btn-block btn-outline-info btn-sm"><i
                                            class="fas fa-clipboard-list"></i> Lihat Perawatan</button></div>
                            </div>
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group row">
                                            <label for="layout"
                                                class="col-sm-4 col-form-label"><span>Layout</span></label>
                                            <div class="col-sm-8">
                                            ...
                                            <button type="button"
                                                class="btn btn-block btn-outline-secondary btn-sm">Layout</button>
                                        </div>
                                    </div>
