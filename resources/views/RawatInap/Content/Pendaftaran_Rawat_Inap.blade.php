          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="col-8">
                    <input type="text" class="form-control" id="faktur_rawatjalan" name="faktur_rawatjalan" placeholder="Rawat Jalan" value="{{$lihat->faktur_rawatjalan}}" disabled >
                  </div>
                  <div class="col-1 text-right">
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-rawatjalan" disabled>
                      <i class="fa fa-search"></i>
              ...
              <div class="row">
                  <div class="col-3">
                    <h6>Nomor Rekam Medis</h6>
                    <input type="text" class="form-control" id="norm" name="norm" placeholder="Nomor Rekam Medis" value="{{$lihat->norm}}" disabled>
                  </div>
                  <div class="col-4">
                    <h6>Pasien</h6>
                  ...
                  <div class="col-4">
                    <h6>Tanggal Masuk</h6>
                    <input type="text" class="form-control" id="tglmasuk" name="tglmasuk" placeholder="Tanggal Masuk" value="{{$lihat->tglmasuk}}" disabled>                 
                  </div>
                  <div class="col-1 align-self-end text-right">
                    <button type="button" onclick="tanggalsekarang();" class="btn btn-outline-info" disabled>
                      <i class="fas fa-sync"></i>
              ...
              <div class="row">
                  <div class="col">
                    <h6>Kode Kamar</h6>
                    <input type="text" class="form-control" id="kodekamar" name="kodekamar" placeholder="Kode Kamar" value="{{$lihat->kodekamar}}" disabled >
                  </div>
                  <div class="col">
                    <h6>Kamar</h6>
                    <input type="text" class="form-control" id="namakamar" name="namakamar"  placeholder="Kamar" value="{{$lihat->Kamar->keterangan}}" disabled>                 
                  </div>
                  <div class="col">
                    <h6>Kelas</h6>
                    <input type="text" class="form-control" id="kelas" name="kelas" placeholder="Kelas" value="{{$lihat->kelas}}" disabled>                                  
                  </div>
                  <div class="col-3">
                    <h6>Ruang</h6>
                    <input type="text" class="form-control" id="ruang" name="ruang" placeholder="Ruang" value="{{$lihat->ruang}}" disabled>                  
                  </div>
                  <div class="col-1 text-right align-self-end">
                    <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-kamar" disabled>
                      <i class="fa fa-search"></i>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <select class="form-control" name="macamrawat" disabled>
                    <option value="">Pilih Macam Rawat</option>
                    @foreach ($macamrawat as $item)
                      <option value="{{$item->kode}}" {{($lihat->macamrawat == $item->kode) ? "selected":""}}>{{$item->macamrawat}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col">
                  ...
                  <input type="text" class="form-control" id="namaperusahaan" name="namaperusahaan" placeholder="Perusahaan / jaminan" value="{{$lihat->Perusahaan->namaprsh}}" disabled >
                </div>
                <div class="col-1 text-right align-self-end">
                  <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-perusahaan" disabled>
                    <i class="fa fa-search"></i>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <select class="form-control" name="kodemasuk" disabled>
                    <option value="">Pilih Cara Masuk</option>
                    @foreach ($jenismasuk as $item)
                      <option value="{{$item->kodemasuk}}" {{($lihat->kodemasuk == $item->kodemasuk) ? "selected":""}}>{{$item->jenismasuk}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col">
                  <h6>Dokter Penanggung Jawab</h6>
                  <input type="text" id="iddokter" name="iddokter" value="{{$lihat->iddokter}}" disabled hidden>
                  <input type="text" class="form-control" id="namadokter" name="namadokter" placeholder="Dokter Penanggung Jawab" value="{{$lihat->Dokter->nama}}" disabled >
                </div>
                <div class="col-1 text-right align-self-end">
                  <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-dokter" disabled>
                    <i class="fa fa-search"></i>
              ...
              <div class="row">
                <div class="col">
                  <h6>Diagnosa Awal</h6>
                  <input type="text" id="diagnosaawal" name="diagnosaawal" value="{{$lihat->diagnosaawal}}" disabled hidden>
                  <input type="text" class="form-control" id="namadiagnosaawal" name="namadiagnosaawal" placeholder="Diagnosa Awal"  value="{{$lihat->namadiagnosaawal}}" disabled>
                </div>
                <div class="col-1 text-right align-self-end">
                  <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-icd10" disabled>
                    <i class="fa fa-search"></i>
              ...
              <div class="row">
                <div class="col">
                  <h6>Penanggung Jawab</h6>
                  <input type="text" class="form-control" name="penanggungjawab" placeholder="Penanggung Jawab"  value="{{$lihat->penanggungjawab}}" disabled>
                </div>
                <div class="col">
                  <h6>Hubungan Penanggung Jawab</h6>
                  <input type="text" class="form-control" name="hubungan_pj" placeholder="Hubungan Penanggung Jawab"  value="{{$lihat->hubungan_pj}}" disabled>
                </div>
                <div class="col">
                  <h6>Telp Penanggung Jawab</h6>
                  <input type="text" class="form-control" name="telp_pj" placeholder="Telp Penanggung Jawab"  value="{{$lihat->telp_pj}}" disabled>
                </div>
              </div>
              <br>
              <div class="row">
                <div class="col">
                  <h6>Alamat Penanggung Jawab</h6>
                  <input type="text" class="form-control" name="alamat_pj" placeholder="Alamat Penanggung Jawab"  value="{{$lihat->alamat_pj}}" disabled>
                </div>
                <div class="col-4">
                  <h6>Biaya Administrasi</h6>
                  <input type="text" class="form-control" name="administrasi" placeholder="Biaya Administrasi"  value="{{$lihat->administrasi}}" disabled>
                </div>
              </div>
