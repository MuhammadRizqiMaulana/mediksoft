                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <a class="btn btn-outline-success btn-sm" href="{{url('Ruang/#TambahRuang')}}"><i
                                            class="fa fa-plus-circle"></i> Tambah</a>
                                    <button type="button" class="btn btn-outline-secondary btn-sm"><a
                                            href="/Ruang/cetakdataruang">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Ruang/ubah{{$item->koderuang}}#UbahRuang"
                                                class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="/Ruang/hapus{{$item->koderuang}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="namaruang" name="namaruang"
                                        placeholder="namaruang">
                                    @if ($errors->has('namaruang'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('namaruang') }}</p>
                                    </span>
                                    @endif
                                </div>
                            </div>
                        ...
                        <form action="{{url('/Ruang/update'.$ubah->koderuang)}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="koderuang" name="koderuang"
                                        placeholder="koderuang" value="{{$ubah->koderuang}}" disabled>
                                    @if ($errors->has('koderuang'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('koderuang') }}</p>
                                    </span>
                                ...
                                <div class="form-group">
                                    <label for="namaruang">nama ruang</label>
                                    <textarea class="form-control" id="namaruang" name="namaruang"
                                        placeholder="namaruang">{{$ubah->namaruang}}</textarea>
                                    @if ($errors->has('namaruang'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('namaruang') }}</p>
                                    </span>
