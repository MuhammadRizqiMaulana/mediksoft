                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <a class="btn btn-outline-success btn-sm" href="{{url('Poli/#TambahBank')}}"><i
                                            class="fa fa-plus-circle"></i> Tambah</a>
                                    <button type="button" class="btn btn-outline-secondary btn-sm"><a
                                            href="/Bank/cetakdatabank">
                                            <i class="fa fa-print"></i> Cetak Data Bank
                                        </a></button>
                                </div>
                            </div>
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->telp}}</td>
                                        <td>
                                            <a href="/Bank/ubah{{$item->idbank}}#UbahBank"
                                                class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="/Bank/hapus{{$item->idbank}}" class="btn btn-outline-danger btn-sm"
                                                onclick="return confirm('Anda yakin mau menghapus bank ini ?')">
                        ...
                        <form action="{{url('/Bank/store')}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="namabank" name="namabank"
                                        placeholder="namabank"></textarea>
                                    @if ($errors->has('namabank'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('namabank') }}</p>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                        ...
                        <form action="{{url('/Bank/update'.$ubah->idbank)}}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="namabank">Nama bank</label>
                                    <textarea class="form-control" id="namabank" name="namabank"
                                        placeholder="namabank">{{$ubah->namabank}}</textarea>
                                    @if ($errors->has('namabank'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('namabank') }}</p>
                                    </span>
                                ...
                                <div class="form-group">
                                    <label for="telp">Telp</label>
                                    <textarea class="form-control" id="telp" name="telp"
                                        placeholder="telp">{{$ubah->telp}}</textarea>
                                    @if ($errors->has('telp'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('telp') }}</p>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="keterangan" name="keterangan"
                                        placeholder="keterangan">{{$ubah->keterangan}}</textarea>
                                    @if ($errors->has('keterangan'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('keterangan') }}</p>
                                    </span>
