                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    ...
                                    <button type="button" class="btn btn-outline-secondary btn-sm"><a
                                            href="/Poli/cetakdatapoli">
                                            <i class="fa fa-print"></i> Cetak Data Poli
                                        </a></button>
                                </div>
                            </div>
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Poli/ubah{{$item->kode}}#UbahFaskes"
                                                class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="/Poli/hapus{{$item->kode}}" class="btn btn-outline-danger btn-sm"
                        ...
                        <form action="{{url('/Poli/store')}}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('jenispoli') }}</p>
                                    </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="nama" name="nama"
                                        placeholder="nama">{{$ubah->nama}}</textarea>
                                    @if ($errors->has('nama'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('nama') }}</p>
                                    </span>
