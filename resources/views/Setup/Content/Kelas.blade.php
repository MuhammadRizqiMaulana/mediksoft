                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <a class="btn btn-outline-success btn-sm" href="{{url('Poli/#TambahPoli')}}"><i
                                            class="fa fa-plus-circle"></i> Tambah</a>
                                    <button type="button" class="btn btn-outline-secondary btn-sm"><a
                                            href="/Kelas/cetakdatakelas">
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->nama}}</td>
                                        <td>
                                            <a href="/Kelas/ubah{{$item->kodekelas}}#UbahFaskes"
                                                class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="/Kelas/hapus{{$item->kodekelas}}"
                        ...
                        <form action="{{url('/Kelas/store')}}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('nama kelas') }}</p>
                                    </span>
                                    @endif
                                </div>
                        ...
                        <form action="{{url('/Kelas/update'.$ubah->kodekelas)}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kodekelas" name="kodekelas"
                                        placeholder="kode kelas" value="{{$ubah->kodekelas}}" disabled>
                                    @if ($errors->has('kodekelas'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('kodekelas') }}</p>
                                    </span>
                                ...
                                <div class="form-group">
                                    <label for="nama">Nama Kelas</label>
                                    <textarea class="form-control" id="nama" name="nama"
                                        placeholder="nama kelas">{{$ubah->nama}}</textarea>
                                    @if ($errors->has('nama kelas'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('namakelas') }}</p>
                                    </span>
                                    @endif
                                </div>
                            </div>
