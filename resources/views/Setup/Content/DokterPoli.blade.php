                            ...
                            <div class="row">
                                <div class="col-sm-6 text-left">
                                    <a class="btn btn-outline-success btn-sm"
                                        href="{{url('DokterPoli/#TambahDokterPoli')}}"><i class="fa fa-plus-circle"></i>
                                        Tambah</a>
                                    <button type="button" class="btn btn-outline-secondary btn-sm"><a
                                            href="/DokterPoli/cetakdatadokterpoli">
                                            <i class="fa fa-print"></i> Cetak Data Dokter Poli
                                        </a></button>
                                </div>
                            </div>
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/DokterPoli/ubah{{$item->kodepoli}},{{$item->iddokter}}#UbahDokterPoli"
                                                class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="/DokterPoli/hapus{{$item->kodepoli}},{{$item->iddokter}}"
