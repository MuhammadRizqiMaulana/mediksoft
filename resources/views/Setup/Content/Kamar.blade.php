                            ...
                            <div class="row">
                                <div class="col">
                                    <a class="btn btn-outline-success btn-block btn-sm"
                                        href="{{url('Kamar/#TambahKamar')}}"><i class="fa fa-plus-circle"></i>
                                        Tambah</a>
                                </div>
                                <div class="col">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('kodekamar') }}</p>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control" id="kelas" name="kodekelas"
                                                placeholder="Kelas" hidden>
                                    ...
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('kodekelas') }}</p>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control" id="ruang" name="koderuang"
                                                placeholder="Ruang" hidden>
                                            <input type="text" class="form-control" id="namaruang" name="namaruang"
                                                placeholder="Ruang" readonly>
                                        </div>
                                        <div class="col-2 text-right">
                                            <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                                data-target="#modal-ruang">
                                                <i class="fa fa-search"></i>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('koderuang') }}</p>
                                    </span>
                                    @endif
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="jasaperawat" name="jasaperawat"
                                                placeholder="Jasa Perawat">
                                            @if ($errors->has('jasaperawat'))
                                            <span class="text-danger">
                                                <p class="text-right">* {{ $errors->first('jasaperawat') }}</p>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" id="tglaktif"
                                                name="tglaktif" placeholder="Tanggal Aktif">
                                            @if ($errors->has('tglaktif'))
                                            <span class="text-danger">
                                                <p class="text-right">* {{ $errors->first('tglaktif') }}</p>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="jumlahbed" name="jumlahbed"
                                                placeholder="Jumlah Bed">
                                            @if ($errors->has('jumlahbed'))
                                            <span class="text-danger">
                                                <p class="text-right">* {{ $errors->first('jumlahbed') }}</p>
                                            </span>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <div class="card card-primary card-outline" id="UbahKamar">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="javascript:alert('Pilih baris data yang akan dihapus!');" id="tombolhapus"
                                        class="btn btn-outline-danger btn-block btn-sm"
                                        onclick="return confirm('Anda yakin mau menghapus item ini ?')">
                                        <i class="fa fa-minus-circle"></i> Hapus
                                    </a>
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-outline-secondary btn-sm"><a
                                            href="/Kamar/cetakdatakamar">
                                            <i class="fa fa-print"></i> Cetak Data Kamar
                                        </a></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control" id="kelas" name="kodekelas"
                                                placeholder="Kelas" value="{{$ubah->kodekelas}}" hidden>
                                            <input type="text" class="form-control" id="namakelas" name="namakelas"
                                                placeholder="Kelas"
                                                value="@if(isset($ubah->Kelas)){{$ubah->Kelas->nama}}@endif" readonly>
                                        </div>
                                        <div class="col-2 text-right">
                                            <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                                data-target="#modal-kelas">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control" id="ruang" name="koderuang"
                                                placeholder="Ruang" value="{{$ubah->koderuang}}" hidden>
                                            <input type="text" class="form-control" id="namaruang" name="namaruang"
                                                placeholder="Ruang"
                                                value="@if(isset($ubah->Ruang)){{$ubah->Ruang->namaruang}}@endif"
                                                readonly>
                                        </div>
                                        <div class="col-2 text-right">
                                            <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                ...
                                <div class="form-group">
                                    <label for="keterangan">Keterangan</label>
                                    <input type="text" class="form-control" id="keterangan" name="keterangan"
                                        placeholder="Keterangan" value="{{$ubah->keterangan}}">
                                    @if ($errors->has('keterangan'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('keterangan') }}</p>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="tarif">Tarif</label>
                                            <input type="text" class="form-control" id="tarif" name="tarif"
                                                placeholder="Tarif" value="{{$ubah->tarif}}">
                                            @if ($errors->has('tarif'))
                                            <span class="text-danger">
                                                <p class="text-right">* {{ $errors->first('tarif') }}</p>
                                            </span>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="jasaperawat">Jasa Perawat</label>
                                            <input type="text" class="form-control" id="jasaperawat" name="jasaperawat"
                                                placeholder="Jasa Perawat" value="{{$ubah->jasaperawat}}">
                                            @if ($errors->has('jasaperawat'))
                                            <span class="text-danger">
                                                <p class="text-right">* {{ $errors->first('jasaperawat') }}</p>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="tglaktif">Tanggal Aktif</label>
                                            <input type="datetime" class="form-control" id="tglaktif" name="tglaktif"
                                                placeholder="Tanggal Aktif" value="{{$ubah->tglaktif}}">
                                            @if ($errors->has('tglaktif'))
                                            <span class="text-danger">
                                                <p class="text-right">* {{ $errors->first('tglaktif') }}</p>
                                            </span>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="jumlahbed">Jumlah Bed</label>
                                            <input type="text" class="form-control" id="jumlahbed" name="jumlahbed"
                                                placeholder="Jumlah Bed" value="{{$ubah->jumlahbed}}">
                                            @if ($errors->has('jumlahbed'))
                                            <span class="text-danger">
                                                <p class="text-right">* {{ $errors->first('jumlahbed') }}</p>
                                            </span>
