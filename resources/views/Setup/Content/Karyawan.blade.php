                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->nama}}</td>
                                        <td>
                                            <a href="/Karyawan/ubah{{$item->idkaryawan}}#UbahKaryawan"
                                                class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                                            <a href="/Karyawan/hapus{{$item->idkaryawan}}"
                    ...
                    <div class="card card-success card-outline" id="TambahKaryawan">
                        ...
                        <form action="{{url('/Karyawan/store')}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-5">
                                        ...
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('nik') }}</p>
                                        </span>
                                        @endif
                                    </div>
                                    <div class="col-sm-7">
                                        ...
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('idjabatan') }}</p>
                                        </span>
                                        @endif
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        @if ($errors->has('noktp'))
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('noktp') }}</p>
                                        </span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="" id="alamatpraktek"
                                        placeholder="Belum Jadi"></textarea>
                                    @if ($errors->has(''))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('') }}</p>
                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="tptlahir"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('jnskelamin') }}</p>
                                        </span>
                                        @endif
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <a href="" class="btn btn-outline-secondary btn-sm">Import Data Karyawan dan
                                            Dokter</a>
                                        <a href="" class="btn btn-outline-secondary btn-sm">Download Format Data
                                            Karyawan dan Dokter</a>
                                    </div>
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="idjabatan">
                                                ...
                                                <option value="{{$item->id}}"
                                                    {{ ($item->id == $ubah->idjabatan) ? 'selected' : ''}}>
                                                    {{$item->nama}}
                                                </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('noregister') }}</p>
                                        </span>
                                        @endif
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col">
                                                <div class="row">
                                                    <span for="tanggaldari" class="col-form-label">Dari</span>
                                                    <div class="col-sm-4">
                                                        <input type="date" class="form-control" name="tanggaldari"
                                                            id="tanggaldari" placeholder="Tanggal">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="row">
                                                    <span for="tanggalsampai" class="col-form-label">Sd</span>
                                                    <div class="col-sm-4">
                                                        <input type="date" class="form-control" name="tanggalsampai"
                                                            id="tanggalsampai" placeholder="Tanggal">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('tanggaldari') }}</p>
                                        </span>
                                        @endif
                                        @if ($errors->has('tanggalsampai'))
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('tanggalsampai') }}</p>
                                        </span>
                                        @endif
                                ...
                                <div class="form-group">
                                    <label class="col-form-label" for="alamatpraktek"> Alamat Praktek</label>
                                    <textarea class="form-control" name="alamatpraktek" id="alamatpraktek"
                                        placeholder="Alamat Praktek"></textarea>
                                    @if ($errors->has('alamatpraktek'))
                                    <span class="text-danger">
                                        <p class="text-right">* {{ $errors->first('alamatpraktek') }}</p>
                                    </span>
                                    @endif
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label>No Telepon</label>
                                            <input type="text" class="form-control" name="notelp"
                                                placeholder="No Telepon" value="{{$ubah->notelp}}">
                                        </div>
                                        @if ($errors->has('notelp'))
                                        <span class="text-danger">
                                            <p class="text-right">* {{ $errors->first('notelp') }}</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="jnskelamin">
                                                <option value="Laki-laki"
                                                    {{ ($ubah->jnskelamin == "Laki-laki") ? 'selected' : ''}}>Laki -
                                                    laki</option>
                                                <option value="Perempuan"
                                                    {{ ($ubah->jnskelamin == "Perempuan") ? 'selected' : ''}}>Perempuan
                                                </option>
                                            </select>
                                        </div>
                                        @if ($errors->has('jnskelamin'))
