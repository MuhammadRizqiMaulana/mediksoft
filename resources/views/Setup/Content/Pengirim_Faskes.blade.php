          ...
          <div class="col-8">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-sm-6">
                    <h4>Data Pengirim / Faskes</h4>
                  </div>
                  <div class="col-sm-6 text-right">
                    <a class="btn btn-outline-success btn-sm" href="{{url('Pengirim_Faskes/#TambahFaskes')}}"><i class="fa fa-plus-circle"></i> Tambah</a>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  @foreach ($datas as $item)
                    <tr>
                      ...
                      <td>{{$item->fee}}</td>
                      <td>
                        <a href="/Pengirim_Faskes/ubah{{$item->kodefaskes}}#UbahFaskes" class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                        <a href="/Pengirim_Faskes/hapus{{$item->kodefaskes}}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
