          ...
          <div class="col-8">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-sm-6">
                    <h4>Data Dokter Konsultasi</h4>
                  </div>
                  <div class="col-sm-6 text-right">
                    <a class="btn btn-outline-success btn-sm" href="{{url('DokterKonsultasi/#TambahDokterKonsultasi')}}"><i class="fa fa-plus-circle"></i> Tambah</a>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  @foreach ($datas as $item)
                    <tr>
                      ...
                      <td>
                        <a href="/DokterKonsultasi/ubah{{$item->iddokter}}#UbahFaskes" class="btn btn-outline-info btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                        <a href="/DokterKonsultasi/hapus{{$item->iddokter}}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Anda yakin mau menghapus item ini ?')">
