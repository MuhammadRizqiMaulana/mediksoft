...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0 text-gray-800">Data Tarif Dokter Konsultasi</h4>
      </div>
    </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-4">
                ...
                <div class="card card-success card-outline" id="TambahDokterKonsultasi">
                  <div class="card-header">
                    <div class="row">
                      <div class="col">
                        <a class="btn btn-outline-success btn-block btn-sm" href="{{url('DokterKonsultasi/#TambahDokterKonsultasi')}}"><i class="fa fa-plus-circle"></i> Tambah</a>
                      </div>
                      <div class="col">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="{{url('/DokterKonsultasi/store')}}" method="post">
                    {{csrf_field()}}
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <label for="nama">Tarif Konsultasi</label>
                        <table border="2">
                          <thead>
                            <tr>
              ...
              @else
                <!-- general form elements -->
                <div class="card card-primary card-outline" id="UbahDokterKonsultasi">
                  <div class="card-header">
                    <div class="row">
                      <div class="col">
                        <a class="btn btn-outline-success btn-block btn-sm" href="{{url('DokterKonsultasi/#TambahKamar')}}"><i class="fa fa-plus-circle"></i> Tambah</a>
                      </div>
                      <div class="col">
                        <a href="javascript:alert('Pilih baris data yang akan diubah!');" id="tombolubah" class="btn btn-outline-info btn-block btn-sm"><i class="fa fa-edit"></i> Ubah</a>
                      </div>
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="{{url('/DokterKonsultasi/update'.$ubah->iddokter)}}" method="post">
                    {{csrf_field()}}
                    <div class="card-body">
                      <div class="form-group">
                        <label for="kelas">Nama Dokter</label>
  ...
  <script type="text/javascript">
    ...
    function tombol($iddokter){
      $("a#tombolubah").attr("href", "/DokterKonsultasi/ubah"+ $iddokter +"#UbahDokterKonsultasi");
      $("a#tombolhapus").attr("href", "/DokterKonsultasi/hapus"+ $iddokter);
    }
