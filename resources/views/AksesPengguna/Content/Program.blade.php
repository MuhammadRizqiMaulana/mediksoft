                        ...
                        <form>
                            <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="custom-tabs-one-perusahaan-tab"
                                            data-toggle="pill" href="#custom-tabs-one-perusahaan" role="tab"
                                            aria-controls="custom-tabs-one-perusahaan"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-one-pengaturan-tab" data-toggle="pill"
                                            ...
                                            aria-controls="custom-tabs-one-pengaturan"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="custom-tabs-one-ndatabase-tab" data-toggle="pill"
                                            ...
                                            aria-controls="custom-tabs-one-ndatabase" aria-selected="false">Nama
                                            Database
                                            Lain</a>
                                    </li>
                                </ul>
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-one-tabContent">
                                    <div class="tab-pane fade active show" id="custom-tabs-one-perusahaan"
                                        role="tabpanel" aria-labelledby="custom-tabs-one-perusahaan-tab">
                                        <section class="content">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <!-- /.col -->
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="row">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="" name="" placeholder="LAB / RAD">
                                                                            <div class="form-check">
                                                                                <input class="form-check-input"
                                                                                    type="checkbox" value="1" id=""
                                                                                    name="">
                                                                                <label class="form-check-label" for="">
                                                                                    Tanpa Aplikasi Laboratorium /
                                                                                    Radiologi
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        <br>
                                                                        <div class="row">
                                                                            <div class="col-3"><label>Farmasi</label>
                                                                            </div>
                                                                            <input type="text" class="form-control"
                                                                                id="" name=""
                                                                                placeholder="URL API Antrian">
