                  ...
                  <form action="{{url('/Data_Pendaftaran/update'.$ubah->faktur_rawatjalan)}}" method="post">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="datetime" class="form-control" id="tglmasuk" name="tglmasuk" placeholder="Tanggal Masuk" value="{{$ubah->tglmasuk}}">
                          </div>
                          <div class="col-2 text-right">
                            <button type="button" class="btn btn-outline-info">
                              <i class="fas fa-calendar"></i>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-4">
                            <label for="norm">No Rekam Medis</label>
                            <input type="text" class="form-control" id="norm" name="norm" placeholder="No Rekam Medis" value="{{$ubah->norm}}" readonly>
                          </div>
                          <div class="col-6">
                            <label for="namapasien">Nama Pasien</label>
                            <input type="text" class="form-control" id="namapasien" name="namapasien" placeholder="Nama Pasien" value="{{$ubah->Pasien->namapasien}}" readonly>
                          </div>
                          <div class="col-2 text-right" >
                            <button type="button" class="btn btn-outline-info align-bottom" data-toggle="modal" data-target="#modal-pasien" disabled>
                              <i class="fa fa-search"></i>
                            </button>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="text" class="form-control" id="poliklinik" name="kodepoli" placeholder="Kode Poli" value="{{$ubah->kodepoli}}" hidden>
                            <input type="text" class="form-control" id="namapoli" name="namapoli" placeholder="Nama Poli" value="{{$ubah->Poliklinik->nama}}" >
                          </div>
                          <div class="col-2 text-right">
                            <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-poliklinik">
                              <i class="fa fa-search"></i>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            ...
                            <input type="text" class="form-control" id="namadokter" name="namadokter" placeholder="Nama Dokter" value="{{$ubah->Dokter->nama}}" >
                          </div>
                          <div class="col-2 text-right">
                            <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-dokter">
                              <i class="fa fa-search"></i>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="text" class="form-control" id="perusahaan" name="idprsh" placeholder="Perusahaan"  value="{{$ubah->idprsh}}" hidden>
                            <input type="text" class="form-control" id="namaprsh" name="namaprsh" placeholder="Nama Perusahaan" value="{{$ubah->Perusahaan->namaprsh}}">
                          </div>
                          <div class="col-2 text-right">
                            <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-perusahaan">
                              <i class="fa fa-search"></i>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="text" class="form-control" id="faskes" name="kodefaskespengirim" placeholder="Pengirim"  value="{{$ubah->kodefaskespengirim}}" hidden>
                            <input type="text" class="form-control" id="namafaskes" name="namafaskes" placeholder="Nama Pengirim" value="{{$ubah->Faskes->namafaskes}}" >
                          </div>
                          <div class="col-2 text-right">
                            <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-faskes">
                              <i class="fa fa-search"></i>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-6">
                            <input type="number" class="form-control" id="administrasi" name="administrasi" min="0" placeholder="Administrasi" value="{{$ubah->administrasi}}">
                              @if ($errors->has('administrasi'))
                                <span class="text-danger"><p class="text-right">* {{ $errors->first('administrasi') }}</p></span>
                              @endif
                          </div>
                  ...
                  <form action="{{url('/Data_Pendaftaran/lihat'.$lihat->faktur_rawatjalan)}}" method="post">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="datetime" class="form-control" id="tglmasuk" name="tglmasuk" placeholder="Tanggal Masuk" value="{{$lihat->tglmasuk}}" disabled>
                          </div>
                          <div class="col-2 text-right">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-4">
                            <label for="norm">No Rekam Medis</label>
                            <input type="text" class="form-control" id="norm" name="norm" placeholder="No Rekam Medis" value="{{$lihat->norm}}" disabled>
                          </div>
                          <div class="col-6">
                            <label for="namapasien">Nama Pasien</label>
                            <input type="text" class="form-control" id="namapasien" name="namapasien" placeholder="Nama Pasien" value="{{$lihat->Pasien->namapasien}}" disabled>
                          </div>
                          <div class="col-2 text-right" >
                            <button type="button" class="btn btn-outline-info align-bottom" data-toggle="modal" data-target="#modal-pasien" disabled>
                              <i class="fa fa-search"></i>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="text" class="form-control" id="poliklinik" name="kodepoli" placeholder="Kode Poli" value="{{$lihat->kodepoli}}" hidden disabled>
                            <input type="text" class="form-control" id="namapoli" name="namapoli" placeholder="Nama Poli" value="{{$lihat->Poliklinik->nama}}"  disabled>
                          </div>
                          <div class="col-2 text-right">
                            <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-poliklinik" disabled>
                              <i class="fa fa-search"></i>
                            </button>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="text" class="form-control" id="dokter" name="iddokter" placeholder="Dokter"  value="{{$lihat->iddokter}}" hidden disabled>
                            <input type="text" class="form-control" id="namadokter" name="namadokter" placeholder="Nama Dokter" value="{{$lihat->Dokter->nama}}"  disabled>
                          </div>
                          <div class="col-2 text-right">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="text" class="form-control" id="perusahaan" name="idprsh" placeholder="Perusahaan"  value="{{$lihat->idprsh}}" hidden disabled>
                            <input type="text" class="form-control" id="namaprsh" name="namaprsh" placeholder="Nama Perusahaan" value="{{$lihat->Perusahaan->namaprsh}}" disabled>
                          </div>
                          <div class="col-2 text-right">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-10">
                            <input type="text" class="form-control" id="faskes" name="kodefaskespengirim" placeholder="Pengirim"  value="{{$lihat->kodefaskespengirim}}" hidden disabled>
                            <input type="text" class="form-control" id="namafaskes" name="namafaskes" placeholder="Nama Pengirim" value="{{$lihat->Faskes->namafaskes}}"  disabled>
                          </div>
                          <div class="col-2 text-right">
                            <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#modal-faskes" disabled>
                              <i class="fa fa-search"></i>
                            </button>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-6">
                            <input type="number" class="form-control" id="administrasi" name="administrasi" min="0" placeholder="Administrasi" value="{{$lihat->administrasi}}" disabled>
                              @if ($errors->has('administrasi'))
                                <span class="text-danger"><p class="text-right">* {{ $errors->first('administrasi') }}</p></span>
                              @endif
                          </div>
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-outline-info" disabled><i class="far fa-save"></i> Simpan</button>
                      <button type="reset" onclick="window.location.href='{{url('Data_Pendaftaran')}}'" class="btn btn-outline-danger"><i class="fa fa-times"></i> Tutup</button>
                    </div>
                  </form>
                </div>
                <!-- /.card -->
